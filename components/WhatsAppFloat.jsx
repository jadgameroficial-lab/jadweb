  ...
  return (
    <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="wa-float" aria-label="Falar no WhatsApp">
      <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <path d="M12.001 2C6.478 2 2 6.478 2 12c0 1.85.5 3.667 1.446 5.253L2 22l4.879-1.415A9.94 9.94 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12.001 2zm0 18.1a8.09 8.09 0 01-4.126-1.13l-.296-.176-3.07.891.897-2.99-.193-.306A8.1 8.1 0 1112 20.1z" />
      </svg>
    </a>
  );
}
